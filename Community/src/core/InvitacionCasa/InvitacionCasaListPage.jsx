...
import { INVITACIONCASA_URL } from "../../routing/CONSTANTS";
...
const InvitacionCasaList = () => {
    ...
    useEffect(() => {
        loadInvitacionCasa();
        setInvitados(parseInt(localStorage.getItem('invitados')));
    }, []);
                        ...
                        <Table>
                            ...
                            <tbody>
                                {ListaInvitacionCasa.map((invitacion) => {
                                    if (parseInt(localStorage.getItem('rol')) == 1 && invitacion.residencial_id == parseInt(localStorage.getItem('residencial_id')))
                                        return (
                                    ...
                                    if (parseInt(localStorage.getItem('rol')) == 4 && invitacion.residencial_id == parseInt(localStorage.getItem('residencial_id')))
                                        return (
                                            <tr key={invitacion.id}>
                                                <td>{invitacion.nombre}</td>
                                                <td>{invitacion.carnet}</td>
                                    ...
                                    if (parseInt(localStorage.getItem('rol')) != 1 && invitacion.dueno_id == parseInt(localStorage.getItem('id')))
                                        return (
                                            <tr key={invitacion.id}>
                                                <td>{invitacion.nombre}</td>
                                                <td>{invitacion.carnet}</td>
