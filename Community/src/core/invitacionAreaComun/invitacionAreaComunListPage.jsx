...
import { INVITACIONAREACOMUN_URL } from "../../routing/CONSTANTS";
                    ...
                    <Card.Body>
                        ...
                        <Table>
                            ...
                            {ListaInvitacionAreacomun.map((invitacion) => {
                                if (parseInt(localStorage.getItem('rol')) == 1 || parseInt(localStorage.getItem('rol')) == 4 && invitacion.residencial_id == parseInt(localStorage.getItem('residencial_id')))
                                    return (
                                        <tr key={invitacion.id}>
                                            ...
                                            {parseInt(localStorage.getItem('rol')) == 4 && invitacion.ingreso == 0 ? (
                                                <td>
                                                ...
                                                parseInt(localStorage.getItem('rol')) == 4 && invitacion.ingreso == 1 ? (
                                                    <td>
                                ...
                                if (parseInt(localStorage.getItem('rol')) == 6 && invitacion.dueo_id == parseInt(localStorage.getItem('id')))
                                    return (
                                        <tr key={invitacion.id}>
                                            <td>{invitacion.nombre}</td>
                                            <td>{invitacion.carnet}</td>
